...
DROP TABLE IF EXISTS kundinnen;
DROP TABLE IF EXISTS lieferantinnen;
DROP TABLE IF EXISTS personal;
DROP TABLE IF EXISTS versandfirmen;
...
CREATE TABLE personal (
    ...
    Einstellung TIMESTAMP NOT NULL,
    Straße varchar(60) NOT NULL,
    Ort varchar(15) NOT NULL,
    Region varchar(15) DEFAULT NULL,
    PLZ varchar(10) NOT NULL,
    Land varchar(15) NOT NULL,
    Telefon_privat varchar(24) DEFAULT NULL,
    Durchwahl_Büro varchar(4) DEFAULT NULL,
    Foto varchar(255) DEFAULT NULL,
    Bemerkungen TEXT,
    Vorgesetzte INTEGER DEFAULT NULL,
    PRIMARY KEY (PersonalNr)
);

CREATE TABLE lieferantinnen (
    LNr SERIAL,
    Firma varchar(40) NOT NULL,
...
CREATE TABLE kundinnen (
    KCode varchar(5) NOT NULL,
    Firma varchar(40) NOT NULL,
    Kontaktperson varchar(30) DEFAULT NULL,
    Position varchar(30) DEFAULT NULL,
    Straße varchar(60) NOT NULL,
...
CREATE TABLE artikel (
    ...
    Auslaufartikel smallint NOT NULL,
    PRIMARY KEY (ArtikelNr),
    CONSTRAINT KategorienArtikel FOREIGN KEY (KategorieNr) REFERENCES kategorien (KategorieNr),
    CONSTRAINT lieferantinnenArtikel FOREIGN KEY (LNr) REFERENCES lieferantinnen (LNr)
);

CREATE TABLE bestellungen (
  BestellNr SERIAL,
  KCode varchar(5) NOT NULL,
  PersonalNr INTEGER default NULL,
  Bestelldatum TIMESTAMP NOT NULL,
  Lieferdatum TIMESTAMP default NULL,
  Versanddatum TIMESTAMP default NULL,
  VersandÜber INTEGER default NULL,
  Frachtkosten decimal(19,4) default NULL,
  Empfänger varchar(40) default NULL,
  ...
  CONSTRAINT kundinnenBestellungen FOREIGN KEY (KCode) REFERENCES kundinnen (KCode) ON UPDATE CASCADE,
  CONSTRAINT PersonalBestellungen FOREIGN KEY (PersonalNr) REFERENCES personal (PersonalNr),
  CONSTRAINT VersandfirmenBestellungen FOREIGN KEY (VersandÜber) REFERENCES versandfirmen (FirmenNr)
);
...
CREATE TABLE bestelldetails (
    ...
    Rabatt decimal(7, 2) NOT NULL,
    PRIMARY KEY (BestellNr, ArtikelNr),
    CONSTRAINT ArtikelBestelldetails FOREIGN KEY (ArtikelNr) REFERENCES artikel (ArtikelNr),
    CONSTRAINT BestellungenBestelldetails FOREIGN KEY (BestellNr) REFERENCES bestellungen (BestellNr) ON DELETE CASCADE
);
...
INSERT INTO versandfirmen (FirmenNr,Firma,Telefon) VALUES 
...
VALUES
    (
        ...
        '5467',
        'EmpID1.bmp',
        'Studium mit Abschluß BA in Psychologie an der Colorado State University. Kurs \"The Art of the Cold Call.\"  Mitglied des Clubs \"Toastmasters International\".',
        2
    ),
    (
        2,
    ...
    (
        ...
        '3355',
        'EmpID3.bmp',
        'Studium mit Abschluß BS in Chemie vom Boston College. Sie hat dort außerdem an dem Kurs \"Betriebsführung und -organisation im Lebensmittel-Einzelhandel\" teilgenommen. Eintritt in die Firma als Verkaufsassistentin. Sie wurde zur Verkaufsrepräsentantin befördert.',
        8
    ),
    (
        4,
        ...
        '5176',
        'EmpID4.bmp',
        'Studium der Englischen Literatur am Concordia College mit Abschluß BA. Studium am American Institute of Culinary Arts mit Abschluß MA. Margaret arbeitete temporär in der Londoner Abteilung bevor sie nach Seattle kam.',
        NULL
    ),
    (
        5,
    ...
    (
        ...
        '465',
        'EmpID7.bmp',
        'Englischstudium an der University of Michigan.  Vorher war Robert King ein Mitglied der amerikanischen Hilfsorganisation \"Peace Corps\". Dann Eintritt in die Firma. Nach Teilnahme am Kurs: \"Selling in Europe\",  Versetzung in die Londoner Abteilung.',
        NULL
    ),
    (
        8,
        ...
        '2344',
        'EmpID8.bmp',
        'Studium mit Abschluß BA in Psychologie an der University of Washington. Kurs: Geschäftsfranzösisch. Laura liest französische Zeitschriften und Zeitungen.',
        NULL
    ),
    (
        9,
        ...
        '452',
        'EmpID9.bmp',
        'Studienabschluß am St. Lawrence College mit BA. Sie spricht fließend Französisch und Deutsch.',
        NULL
    );
...
VALUES
    ...
    (
        ...
        '(06) 431-7877',
        NULL,
        'Mayumi''s (im World Wide Web)#http://www.microsoft.com/accessdev/sampleapps/mayumi.htm#'
    ),
    (
        7,
        'Pavlova, Ltd.',
    ...
    (
        ...
        '(069) 992755',
        NULL,
        'Plutzer (im World Wide Web)#http://www.microsoft.com/accessdev/sampleapps/plutzer.htm#'
    ),
    (
        13,
    ...
    (
        ...
        '(02) 555-5914',
        '(02) 555-4873',
        'G''day Mate (im World Wide Web)#http://www.microsoft.com/accessdev/sampleapps/gdaymate.htm#'
    ),
    (
        25,
        'Ma Maison',
...
INSERT INTO
    kategorien (KategorieNr, Kategoriename, Beschreibung, Abbildung)
VALUES
    (
        1,
        'Getränke',
        'Alkoholfreie Getränke, Kaffee, Tee, Bier',
        ''
    ),
    ...
    (
        7,
        'Naturprodukte',
        'Getrocknete Früchte, Tofu usw.',
        ''
    ),
    (
        8,
        'Meeresfrüchte',
        'Meerespflanzen und -früchte, Fisch',
        ''
    );
...
INSERT INTO artikel (ArtikelNr,Artikelname,LNr,KategorieNr,Liefereinheit,Einzelpreis,Lagerbestand,BestellteEinheiten,Mindestbestand,Auslaufartikel) VALUES 
 (1,'Chai',1,1,'10 Kartons x 20 Beutel','9.0000',39,0,10,0),
 (2,'Chang',1,1,'24 x 12-oz-Flaschen','9.5000',17,40,25,0),
 (3,'Aniseed Syrup',1,2,'12 x 550-ml-Flaschen','5.0000',13,70,25,0),
 (4,'Chef Anton''s Cajun Seasoning',2,2,'48 x 6-oz-Gläser','11.0000',53,0,0,0),
 (5,'Chef Anton''s Gumbo Mix',2,2,'36 Kartons','10.6750',0,0,0,-1),
 (6,'Grandma''s Boysenberry Spread',3,2,'12 x 8-oz-Gläser','12.5000',120,0,25,0),
 (7,'Uncle Bob''s Organic Dried Pears',3,7,'12 x 1-lb-Packungen','15.0000',15,0,10,0),
 (8,'Northwoods Cranberry Sauce',3,2,'12 x 12-oz-Gläser','20.0000',6,0,0,0),
 (9,'Mishi Kobe Niku',4,6,'18 x 500-g-Packungen','48.5000',29,0,0,-1),
 (10,'Ikura',4,8,'12 x 200-ml-Gläser','15.5000',31,0,0,0),
 (11,'Queso Cabrales',5,4,'1-kg-Paket','10.5000',22,30,30,0),
 (12,'Queso Manchego La Pastora',5,4,'10 x 500-g-Packungen','19.0000',86,0,0,0),
 (13,'Konbu',6,8,'2-kg-Karton','3.0000',24,0,5,0),
 (14,'Tofu',6,7,'40 x 100-g-Packungen','11.6250',35,0,0,0),
 (15,'Genen Shouyu',6,2,'24 x 250-ml-Flaschen','7.7500',39,0,5,0),
 (16,'Pavlova',7,3,'32 x 500-g-Kartons','8.7250',29,0,10,0),
 (17,'Alice Mutton',7,6,'20 x 1-kg-Dosen','19.5000',0,0,0,-1),
 (18,'Carnarvon Tigers',7,8,'16-kg-Paket','31.2500',42,0,0,0),
 (19,'Teatime Chocolate Biscuits',8,3,'10 Kartons x 12 Stück','4.6000',25,0,5,0),
 (20,'Sir Rodney''s Marmalade',8,3,'30 Geschenkkartons','40.5000',40,0,0,0),
 (21,'Sir Rodney''s Scones',8,3,'24 Packungen x 4 Stück','5.0000',3,40,5,0),
 (22,'Gustaf''s Knäckebröd',9,5,'24 x 500-g-Packungen','10.5000',104,0,25,0),
 (23,'Tunnbröd',9,5,'12 x 250-g-Packungen','4.5000',61,0,25,0),
 (24,'Guaraná Fantástica',10,1,'12 x 355-ml-Dosen','2.2500',20,0,0,-1),
 (25,'NuNuCa Nuß-Nougat-Creme',11,3,'20 x 450-g-Gläser','7.0000',76,0,30,0),
 (26,'Gumbär Gummibärchen',11,3,'100 x 250-g-Beutel','15.6150',15,0,0,0),
 (27,'Schoggi Schokolade',11,3,'100 x 100-g-Stück','21.9500',49,0,30,0),
 (28,'Rössle Sauerkraut',12,7,'25 x 825-g-Dosen','22.8000',26,0,0,-1),
 (29,'Thüringer Rostbratwurst',12,6,'50 Beutel x 30 Würstchen','61.8950',0,0,0,-1),
 (30,'Nord-Ost Matjeshering',13,8,'10 x 200-g-Gläser','12.9450',10,0,15,0),
 (31,'Gorgonzola Telino',14,4,'12 x 100-g-Packungen','6.2500',0,70,20,0),
 (32,'Mascarpone Fabioli',14,4,'24 x 200-g-Packungen','16.0000',9,40,25,0),
 (33,'Geitost',15,4,'500-g-Packung','1.2500',112,0,20,0),
 (34,'Sasquatch Ale',16,1,'24 x 12-oz-Flaschen','7.0000',111,0,15,0),
 (35,'Steeleye Stout',16,1,'24 x 12-oz-Flaschen','9.0000',20,0,15,0),
 (36,'Inlagd Sill',17,8,'24 x 250-g -Gläser','9.5000',112,0,20,0),
 (37,'Gravad lax',17,8,'12 x 500-g-Packungen','13.0000',11,50,25,0),
 (38,'Côte de Blaye',18,1,'12 x 75-cl-Flaschen','131.7500',17,0,15,0),
 (39,'Chartreuse verte',18,1,'750-ml-Flasche','9.0000',69,0,5,0),
 (40,'Boston Crab Meat',19,8,'24 x 4-oz-Dosen','9.2000',123,0,30,0),
 (41,'Jack''s New England Clam Chowder',19,8,'12 x 12-oz-Dosen','4.8250',85,0,10,0),
 (42,'Singaporean Hokkien Fried Mee',20,5,'32 x 1-kg-Packungen','7.0000',26,0,0,-1),
 (43,'Ipoh Coffee',20,1,'16 x 500-g-Dosen','23.0000',17,10,25,0),
 (44,'Gula Malacca',20,2,'20 x 2-kg-Beutel','9.7250',27,0,15,0),
 (45,'Røgede sild',21,8,'1-kg-Paket','4.7500',5,70,15,0),
 (46,'Spegesild',21,8,'4 x 450-g-Gläser','6.0000',95,0,0,0),
 (47,'Zaanse koeken',22,3,'10 x 4-oz-Kartons','4.7500',36,0,0,0),
 (48,'Chocolade',22,3,'10 Packungen','6.3750',15,70,25,0),
 (49,'Maxilaku',23,3,'24 x 50-g-Packungen','10.0000',10,60,15,0),
 (50,'Valkoinen suklaa',23,3,'12 x 100-g-Riegel','8.1250',65,0,30,0),
 (51,'Manjimup Dried Apples',24,7,'50 x 300-g-Packungen','26.5000',20,0,10,0),
 (52,'Filo Mix',24,5,'16 x 2-kg-Kartons','3.5000',38,0,25,0),
 (53,'Perth Pasties',24,6,'48 Stück','16.4000',0,0,0,-1),
 (54,'Tourtière',25,6,'16 Pasteten','3.7250',21,0,10,0),
 (55,'Pâté chinois',25,6,'24 Kartons x 2 Pasteten','12.0000',115,0,20,0),
 (56,'Gnocchi di nonna Alice',26,5,'24 x 250-g-Packungen','19.0000',21,10,30,0),
 (57,'Ravioli Angelo',26,5,'24 x 250-g-Packungen','9.7500',36,0,20,0),
 (58,'Escargots de Bourgogne',27,8,'24 Stück','6.6250',62,0,20,0),
 (59,'Raclette Courdavault',28,4,'5-kg-Packung','27.5000',79,0,0,0),
 (60,'Camembert Pierrot',28,4,'15 x 300-g-Stücke','17.0000',19,0,0,0),
 (61,'Sirop d''érable',29,2,'24 x 500-ml-Flaschen','14.2500',113,0,25,0),
 (62,'Tarte au sucre',29,3,'48 Törtchen','24.6500',17,0,0,0),
 (63,'Vegie-spread',7,2,'15 x 625-g-Gläser','21.9500',24,0,5,0),
 (64,'Wimmers gute Semmelknödel',12,5,'20 Beutel x 4 Stück','16.6250',22,80,30,0),
 (65,'Louisiana Fiery Hot Pepper Sauce',2,2,'32 x 8-oz-Flaschen','10.5250',76,0,0,0),
 (66,'Louisiana Hot Spiced Okra',2,2,'24 x 8-oz-Gläser','8.5000',4,100,20,0),
 (67,'Laughing Lumberjack Lager',16,1,'24 x 12-oz-Flaschen','7.0000',52,0,10,0),
 (68,'Scottish Longbreads',8,3,'10 Kartons x 8 Stück','6.2500',6,10,15,0),
 (69,'Gudbrandsdalsost',15,4,'10-kg-Paket','18.0000',26,0,15,0),
 (70,'Outback Lager',7,1,'24 x 355-ml-Flaschen','7.5000',15,10,30,0),
 (71,'Fløtemysost',15,4,'10 x 500-g-Packungen','10.7500',26,0,0,0),
 (72,'Mozzarella di Giovanni',14,4,'24 x 200 g-Packungen','17.4000',14,0,0,0),
 (73,'Röd Kaviar',17,8,'24 x 150-g-Gläser','7.5000',101,0,5,0),
 (74,'Longlife Tofu',4,7,'5-kg-Paket','5.0000',4,20,5,0),
 (75,'Rhönbräu Klosterbier',12,1,'24 x 0,5-l-Flaschen','3.8750',125,0,25,0),
 (76,'Lakkalikööri',23,1,'500-ml-Flasche','9.0000',57,0,20,0),
 (77,'Original Frankfurter grüne Soße',12,2,'12 Kartons','6.5000',32,0,15,0);
